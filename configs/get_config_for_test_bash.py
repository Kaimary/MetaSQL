    ...
    for line in f:
        if '=' in line:
            ...
            if k in ["RETRIEVAL_MODEL_EMBEDDING_DIMENSION", "RETRIEVAL_EMBEDDING_MODEL_NAME", \
                ...
                "MODEL_TAR_GZ", "MODE", "DEBUG", "CLASSIFIER_PREDS_FILE", "META_DICT_FILE", \
...
print(f"{config_vars['OUTPUT_DIR_RERANKER']}@{config_vars['RETRIEVAL_EMBEDDING_MODEL_NAME']}@"
    ...
    f"{config_vars['MODEL_BIN']}@{config_vars['SCHEMA_CLASSIFIER_MODEL_DIR']}@{config_vars['SERIALIZE_DATA_DIR']}")
