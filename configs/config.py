...
SEMSIMILARITY_TRIPLE_DATA_GZ_FILE='/output/{0}/sentence_embedder/sentence_emb_lgesql.tsv.gz'
SEMSIMILARITY_TRIPLE_DATA_FINETUNE_GZ_FILE='/output/spider/sentence_embedder/spider_sentence_emb_finetune.tsv.gz'
RETRIEVAL_MODEL_DIR='/saved_models/sentence_embedder'
CANDIDATE_NUM=10
# Default lr is 2e-5 
...
RERANKER_MODEL_DIR='/saved_models/reranker'
