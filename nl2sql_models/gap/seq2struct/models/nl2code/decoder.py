...
from nl2sql_models.gap.seq2struct import grammars
from nl2sql_models.gap.seq2struct.models import abstract_preproc
from nl2sql_models.gap.seq2struct.models import attention
...
from nl2sql_models.gap.seq2struct.models.nl2code.tree_traversal import TreeTraversal
from nl2sql_models.gap.seq2struct.models.nl2code.train_tree_traversal import TrainTreeTraversal
from nl2sql_models.gap.seq2struct.models.nl2code.infer_tree_traversal import InferenceTreeTraversal
...
class NL2CodeDecoder(torch.nn.Module):
    ...
    def __init__(
        ...
        if use_align_mat:
            from nl2sql_models.gap.seq2struct.models.spider import spider_dec_func
