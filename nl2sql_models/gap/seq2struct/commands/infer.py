...
from nl2sql_models.gap.seq2struct import beam_search
...
from nl2sql_models.gap.seq2struct.models.spider import spider_beam_search
        ...
        with torch.no_grad():
            if args.mode == 'infer':
                ...
                try:
                    ...
                    preproc_data = []
                    i = 0
                    for _ in tqdm.tqdm(orig_data, desc=args.section, dynamic_ncols=True):
                        preproc_data.extend(self.model_preproc.process_batch_items(orig_data, args.section))
                        i += 1
                # orig_data = orig_data[67056:]
                # preproc_data = preproc_data[67056:]
                if args.limit:
