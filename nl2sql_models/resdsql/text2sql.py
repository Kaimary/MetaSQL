...
from nl2sql_models.resdsql.utils.spider_metric.evaluator import EvaluateTool
from nl2sql_models.resdsql.utils.load_dataset import Text2SQLDataset
from nl2sql_models.resdsql.utils.text2sql_decoding_utils import decode_sqls, decode_natsqls
...
def _train(opt):
    ...
    for epoch in range(opt.epochs):
        ...
        for batch in train_dataloder:
            ...
            if train_step % num_checkpoint_steps*2 == 0 and epoch >= 80:
