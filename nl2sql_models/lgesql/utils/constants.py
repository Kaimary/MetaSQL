...
# print(os.path.abspath(os.path.join(__location__, os.pardir)))
GRAMMAR_FILEPATH = os.path.join(os.path.abspath(os.path.join(__location__, os.pardir)), 'asdl/sql/grammar/sql_asdl_v2.txt')
