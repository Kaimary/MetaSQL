...
def preprocess_database_and_dataset(db_dir='database/', table_path='data/tables.json', dataset_path='data/dev.json', method='lgesql', saved_table_path=''):
...
dataset, tables = preprocess_database_and_dataset(db_dir=args.db_dir, table_path=args.table_path, dataset_path=args.dataset_path, method=params.model, saved_table_path=args.saved_table_path)
...
model = Registrable.by_name('text2sql_origin')(params, Example.trans).to(device)
